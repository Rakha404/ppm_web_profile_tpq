...
export default function KontakPage() {
  ...
  // Nomor kontak asli TPQ kamu Kha
  ...
  return (
    /* BACKGROUND UTAMA TETAP PUTIH BERSIH SESUAI KEINGINAN KAMU KHA */
        ...
        >
          <div>
            ...
            <p className="text-slate-600 mb-6 leading-relaxed text-sm font-medium text-justify">
              Silakan hubungi Layanan Administrasi TPQ & MDTA Raudlatul Ma'arif An-Nahdliyah untuk informasi pendaftaran santri baru, jadwal kegiatan pembelajaran, atau konsultasi administrasi lainnya. Kami siap melayani Anda.
            </p>
            
            {/* Info List Singkat di Dalam Kartu */}
            <div className="space-y-3.5 text-sm text-slate-600 border-t border-slate-100 pt-5">
              <div className="flex items-center gap-3 bg-slate-50 border border-slate-200/50 p-3 rounded-xl shadow-xs">
                <span className="text-base">⏰</span>
                <span className="font-extrabold text-slate-700">Jam Layanan:</span> 
                <span className="font-semibold text-slate-500 ml-auto">08.00 - 17.00 WIB</span>
              </div>
              <div className="flex items-center gap-3 bg-slate-50 border border-slate-200/50 p-3 rounded-xl shadow-xs">
                <span className="text-base">📞</span>
                <span className="font-extrabold text-slate-700">Nomor Kontak:</span> 
                <span className="font-semibold text-slate-500 ml-auto">+62 881-9725-510</span>
              </div>
            </div>
          </div>
