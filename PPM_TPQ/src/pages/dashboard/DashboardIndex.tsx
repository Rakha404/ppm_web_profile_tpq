  ...
  return (
    <div className="p-6 font-sans min-h-screen bg-slate-50">
      ...
      <div className="bg-gradient-to-r from-[#006432] to-emerald-950 p-6 md:p-8 rounded-3xl shadow-xs text-white mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-2">
          ...
          <p className="text-emerald-100/80 text-xs md:text-sm font-medium leading-relaxed max-w-xl">
            Silakan pilih modul navigasi kontrol di bawah ini untuk mengubah susunan data teks, album foto, slider gambar, hingga memverifikasi calon santri baru.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        >
          <div>
            <h3 className="text-sm font-black text-slate-800 uppercase tracking-wide group-hover:text-[#006432] transition-colors">
              Kelola Beranda
            </h3>
          ...
          <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-wider mt-5 block group-hover:translate-x-1 transition-transform">
            Buka Pengaturan →
          </span>
        </Link>

        {/* Card 2: Kelola Teks Profil & Pendidikan */}
        <Link 
        ...
        >
          <div>
            <h3 className="text-sm font-black text-slate-800 uppercase tracking-wide group-hover:text-[#006432] transition-colors">
              Kelola Kontak & Footer
            </h3>
            <p className="text-slate-500 text-[11px] mt-2 leading-relaxed font-medium">
              Ubah nomor telepon topbar, tautan profil Instagram, Facebook, Youtube, serta isi dua tombol layanan WhatsApp secara dinamis.
            </p>
          </div>
          <span className="text-[10px] font-bold text-emerald-700 uppercase tracking-wider mt-5 block group-hover:translate-x-1 transition-transform">
            Buka Pengaturan →
        ...
        {/* Card 6: Kotak Masukan Kritik Saran */}
        <Link 
        ...
        {/* Card 8: Data Real-Time Pendaftaran Online (Full Width) */}
        <Link
        ...
        >
          ...
          <div className="bg-slate-50 px-5 py-3 rounded-xl border border-slate-100 text-center shrink-0 min-w-[120px] group-hover:bg-white group-hover:border-emerald-200 transition-all">
            ...
            <span className="text-xl font-black text-[#006432]">
              {totalSantri} <span className="text-xs font-normal text-slate-500">Anak</span>
            </span>
          </div>
        </Link>
