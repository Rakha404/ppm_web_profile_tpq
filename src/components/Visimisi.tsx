      ...
      <div className="max-w-7xl mx-auto space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-xs border border-slate-100 relative overflow-hidden flex flex-col justify-between group hover:shadow-md transition-shadow">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-emerald-50 text-[#006432] rounded-2xl"><Target size={26} /></div>
            ...
            <div className="text-[11px] font-bold text-emerald-700/40 uppercase tracking-widest pt-8 self-end">Raudlatul Ma'arīf</div>
          </div>
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-xs border border-slate-100 relative overflow-hidden flex flex-col justify-between group hover:shadow-md transition-shadow">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-emerald-50 text-[#006432] rounded-2xl"><CheckCircle2 size={26} /></div>
              ...
              <div className="flex flex-col gap-3">
                {listMisi.map((misi, index) => (
                  <div key={index} className="flex items-start gap-3 p-1.5 rounded-xl">
                    <span className="flex items-center justify-center w-6 h-6 rounded-full bg-[#006432] text-white text-[11px] font-bold shrink-0 mt-0.5">{index + 1}</span>
                    <p className="text-slate-600 text-xs md:text-sm leading-relaxed">{misi}</p>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="bg-white rounded-[2rem] p-8 shadow-xs border border-slate-100 relative overflow-hidden flex flex-col justify-between group hover:shadow-md transition-shadow md:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-amber-50 text-[#FF9900] rounded-2xl"><Award size={26} /></div>
            ...
            <div className="text-[11px] font-bold text-amber-700/40 uppercase tracking-widest pt-8 self-end">Motto Utama</div>
          </div>
        </div>
      </div>
    </section>
