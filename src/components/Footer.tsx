...
export const Footer = () => {
    ...
    return (
        <footer className="w-full bg-[#006432] text-white pt-16 pb-6 px-6 md:px-12 font-sans select-none overflow-hidden">
            <div className="max-w-7xl mx-auto space-y-12">

                {/* ================= SECTION 1: KEUNGGULAN PENDIDIKAN (ATAS) ================= */}
                {/* Diberi efek fade-up agar naik perlahan dari bawah */}
                <div 
                    data-aos="fade-up"
                ...
                >
                    <div className="space-y-1">
                        ...
                        <h2 className="text-xl md:text-3xl font-black tracking-wide drop-shadow-sm">
                            TPQ & MDTA RAUDLATUL MA'ARIF AN-NAHDLIYAH
                        </h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto pt-2">
                        ...
                        <div className="flex flex-col items-center text-center space-y-3 group cursor-pointer">
                            <span className="text-4xl text-amber-400 drop-shadow-md transition-transform duration-300 group-hover:scale-120 group-hover:-translate-y-1">🤲</span>
                ...
                {/* Menggunakan fade-up dengan delay sedikit agar muncul bergantian */}
                <div 
                    data-aos="fade-up" 
                    data-aos-delay="200"
                ...
                >
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-3 text-xs md:text-sm text-emerald-100/90 font-medium">
                            ...
                            <div className="flex items-center gap-2.5 group">
                                ...
                                <a href="tel:+628819725510" className="hover:underline hover:text-white transition-colors">+62 881-9725-510</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2.5 text-sm font-semibold text-emerald-100/90">
                            <a href="#" className="flex items-center gap-2 hover:text-white transition-all duration-300 hover:translate-x-1">
                    ...
                    {/* Kolom C (3/12): Deskripsi Singkat Lembaga */}
                    <div className="lg:col-span-3 flex flex-col gap-4">
                        <h3 className="text-md font-bold tracking-wider text-amber-400 uppercase border-b border-emerald-700/60 pb-1.5">
                            Tentang Kami
                        </h3>
                        <p className="text-xs md:text-sm text-emerald-100/80 leading-relaxed text-justify font-medium">
                            Raudlatul Ma'arif An-Nahdliyah merupakan lembaga pendidikan non-formal yang menyelenggarakan Taman Pendidikan Al-Qur'an (TPQ) dan Madrasah Diniyah Takmiliyah Awaliyah (MDTA). Kami hadir memberikan fondasi keagamaan kuat bagi putra-putri sesuai tuntunan adab Islam.
                        </p>
                    </div>
                    ...
                    <div className="lg:col-span-3 flex flex-col gap-4">
                        <div className="flex justify-between items-center border-b border-emerald-700/60 pb-1.5">
                            ...
                            <a
                                href="https://maps.google.com/?q=TPQ+Raudlatul+Ma%27arif+An-Nahdliyah&ftid=0x2e6bbe002fbe8e93:0xcda6be9f584e0c3d"
                                target="_blank"
                        ...
                        <div className="w-full h-36 rounded-2xl overflow-hidden shadow-inner border border-emerald-700/80 bg-emerald-900/50 group">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.672520330656!2d109.18683500000001!3d-6.929729!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6bbe002fbe8e93%3A0xcda6be9f584e0c3d!2sTPQ%20Raudlatul%20Ma&#39;arif%20An-Nahdliyah!5e0!3m2!1sid!2sid!4v1718815000000!5m2!1sid!2sid"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                ...
                                title="Peta Lokasi Raudlatul Ma'arif"
                                className="transition-transform duration-700 group-hover:scale-105 grayscale-[20%] contrast-[110%] group-hover:grayscale-0"
                            ></iframe>
                        </div>
                    </div>
                ...
                {/* Diberi efek fade-in standar tanpa pergeseran posisi */}
                <div 
                    data-aos="fade-in"
                    data-aos-delay="400"
                    className="flex flex-col sm:flex-row justify-between items-center text-[11px] text-emerald-300/70 font-medium gap-2 pt-2"
                >
                    <p>© 2026 Raudlatul Ma'arif An-Nahdliyah. All Rights Reserved.</p>
                    <p className="transition-colors duration-300 hover:text-amber-400 cursor-default">Designed for TPQ & MDTA Awaliyah</p>
                </div>
